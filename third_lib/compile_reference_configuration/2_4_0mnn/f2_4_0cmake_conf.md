...
ls -lh
# 以上配置：
# DMNN_BUILD_MINI---关正常编译约3.0mb---arm-buildroot-linux-gnueabihf-strip libMNN.so---极限2404k
# DMNN_BUILD_MINI---开约2.2mb---arm-buildroot-linux-gnueabihf-strip libMNN.so---极限1750k ——int8不可用
...
cp /home/luo/nfs/result.jpg ~/linux/6ull/project/peripheral_vision_ai_acquisition_terminal/output/
