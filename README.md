...
mount -t nfs -o nolock,port=2050 192.168.5.10:~/nfs /mnt
date -s "2026-05-22 12:00:00"
cd /mnt/run_on_board/
# 一次性添加所有库路径，大小写正确，永久生效当前终端
export LD_LIBRARY_PATH=/mnt/run_on_board/openh264:/mnt/run_on_board/libyuv:$LD_LIBRARY_PATH
...
- [OpenCV](https://github.com/opencv/opencv) | 4.5.5 | Apache 2.0 | 图像调试处理 |
## 第三方许可证说明
