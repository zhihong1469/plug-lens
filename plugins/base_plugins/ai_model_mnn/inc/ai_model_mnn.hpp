 ...
 * @brief   MNN UltraFace Face Detection Model - Pure C External Interface
 * @details Core capabilities for embedded Linux vision AI:
 *          1. Optimized for NXP i.MX6ULL platform
 *          2. Isolated BGR buffer prevents memory collision
 *          3. Zero-copy integration with frame_link subsystem
 *          4. Pure C API hides underlying C++ implementation
...
/**
 * @defgroup ai_model_mnn MNN Face Detection Model (Pure C API)
 * @brief MNN-based UltraFace face detection implementation,
...
/**
 * @brief   Create and initialize MNN face detection singleton instance
 ...
 *     .iou_thresh = 0.3f,
 * };
 * ai_model_handle_t* handle = ai_model_mnn_create(&cfg);
 *
 * // 2. Run inference
 ...
 *
 * // 3. Draw and save
 * ai_model_mnn_map_and_draw_faces(
